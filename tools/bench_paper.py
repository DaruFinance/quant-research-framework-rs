#!/usr/bin/env python3
"""Paper-grade benchmark: extends tools/bench.py with N=5 runs, std/IQR
...
quant-research-framework paper (which reports n=5 throughout).

Usage:
    python tools/bench_paper.py --runs 5 --out bench_paper.csv
"""
...
DEFAULT_RUNS = 5  # matches the paper's reported n=5
